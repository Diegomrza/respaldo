...
MODULE_LICENSE("GPL");
MODULE_DESCRIPTION("Creacion del modulo en Linux de CPU, Sistemas operativos 1 - 201901429");
...
{
    proc_create("cpu_201901429", 0, NULL, &operaciones);
    printk(KERN_INFO "Creado el archivo /proc/cpu_201901429\n");
    return 0;
}

static void _delete(void)
{
    remove_proc_entry("cpu_201901429", NULL);
    printk(KERN_INFO "Eliminado el archivo /proc/cpu_201901429\n");
}
